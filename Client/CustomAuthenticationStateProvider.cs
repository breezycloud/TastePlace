...
public class CustomAuthenticationStateProvider : AuthenticationStateProvider
{
    ...
    public async Task SetTokenAsync(User response)
    {
        ...
        else
        {
            ...
            await _localStorage.SetItemAsync("uid", response.Id.ToString());
            await _localStorage.SetItemAsync("access", response.Role.ToString());
        }
